...
all_folders = ["FHP 2k", "FHP 3k", "FHP 5k", "FHP 10k", "FHP 20k", "FHP 50k", "FHP 75k", "FHP 100k"]
...
# GasPlotter.plotDifference(folder=folderPath + "/FHPparticleDistributions(115247)", numParticles=115247)
# GasPlotter.plotDataset(folder=folderPath + "/FHPparticleDistributions(115247)", numParticles=115247)
aran = np.arange(5000, 75001, 5000)

# for num_particles in aran:
#     folder_name = folderPath + "/FHPparticleDistributions(" + str(num_particles) + ")"
#     model_name = "FHP"
#     GasPlotter.plotDataset(folder=folder_name, numParticles=num_particles, model=model_name)

GasPlotter.plotAllEquilibria(folderPath + "/FHPparticleDistributions", folderPath + "/HPPparticleDistributions", np.arange(5000, 115001, 5000), folderPath)
